...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train LightSpeech (See detail in tensorflow_tts/bin/train-fastspeech.py)")
    ...
    parser.add_argument( "--f0-stat", default="./dump/stats_f0.npy",type=str, required=True, help="f0-stat path.", )
    parser.add_argument( "--energy-stat", default="./dump/stats_energy.npy", type=str, required=True,  help="energy-stat path.", )
    ...
    parser.add_argument("--pretrained",default="", type=str,nargs="?",
