...
class CharactorDurationF0EnergyMelDataset(AbstractDataset):
    ...
    def __init__(
        ...
        spk_emb_files = sorted(find_files(root_dir, spk_emb_query))
        ...
        assert (
            ...
            == len(energy_files)
            ==len(spk_emb_files)
        ), f"Number of charactor, mel, duration, f0 ,spk_emb and energy files are different"
        ...
        self.spk_emb_files=spk_emb_files
        ...
        self.spk_emb_load_fn=spk_emb_load_fn
    ...
    def generator(self, utt_ids):
        for i, utt_id in enumerate(utt_ids):
            ...
            spk_emb_file=self.spk_emb_files[i]
    ...
    def _load_data(self, items):
        ...
        spk_emb= tf.numpy_function(np.load, [items["spk_emb_files"]], tf.float32)
