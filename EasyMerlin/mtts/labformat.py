...
def tree_per_word(word, cur_rhythm, tree_init, syllables, poses):
    ...
    #$print('cur_rhythm:',cur_rhythm)
    #print('rhythm_map:',rhythm_map)
    ...
    if cur_rhythm == 'ph':
        ...
        for syllable in syllables[0:len(word)]:
            ...
            tree_per_word(''.join(syllable), smaller_rhythm, tree_init,syllables, poses)
    ...
    # 创建节点
    if cur_rhythm == 'ph':
        newNode = LabNode(txt=word, index=len(current_rhythm_list) + 1, rhythm=cur_rhythm)
